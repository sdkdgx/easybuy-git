...
public class EasyBuyOrder {
	...
	private sdust.easybuy.model.EasyBuyUser easybuyUser;
	...
	/** minimal constructor */
	public EasyBuyOrder(sdust.easybuy.model.EasyBuyUser easybuyUser, Timestamp eoCreateTime,
	...
	public sdust.easybuy.model.EasyBuyUser getEasybuyUser() {
		return this.easybuyUser;
	}

	public void setEasybuyUser(sdust.easybuy.model.EasyBuyUser easybuyUser) {
		this.easybuyUser = easybuyUser;
	}
